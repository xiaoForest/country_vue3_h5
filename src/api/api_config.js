let ServerOrNot = 0
export const baseUrl = `${ServerOrNot==1?'http://localhost:44351/':'https://gdxczx.gd.gov.cn/'}`
export const appBaseUrl = "https://gdxczx.gd.gov.cn/"
...
export const defaultHeadMale = "https://gdxczx.gd.gov.cn/favicon.ico"
export const defaultHeadFemale = "https://gdxczx.gd.gov.cn/favicon.ico"
